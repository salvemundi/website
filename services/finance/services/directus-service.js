...
async function getTransactionByMollieId(directusUrl, directusToken, mollieId) {
    try {
        const query = new URLSearchParams({
        ...
        console.error(`Failed to fetch transaction by Mollie ID ${mollieId}:`, error.message);
        return null;
    }
}

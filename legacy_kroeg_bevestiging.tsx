    ...
    useEffect(() => {
        ...
        const checkStatus = async () => {
            try {
                ...
                if (statusValue === 'paid') {
                    console.log('[Kroegentocht Bevestiging] Γ£à Payment is PAID!');
                    ...
                    console.log('[Kroegentocht Bevestiging] Γ¥î Payment failed/canceled/expired');
                    setStatus('failed');
                    ...
                    console.log('[Kroegentocht Bevestiging] ΓÜá∩╕Å Max retries reached, status still open');
                    setStatus('open');
                }
            } catch (err) {

                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                <label className="flex items-center">
                                    ...
                                    />
                                    <span className="ml-2 text-sm text-gray-700">Actief (zichtbaar voor deelnemers)</span>
                                </label>
                            </div>
                        </div>
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="flex justify-between items-center mb-4">
                                            ...
                                            {activity.max_participants && (
                                                <span className="text-sm text-gray-500">Max: {activity.max_participants}</span>
                                            )}
                                        </div>
                                        ...
                                        <div className="flex gap-2">
                                            <button
                                                ...
                                                className="flex-1 px-4 py-2 border border-purple-600 text-purple-600 rounded-lg hover:bg-purple-50 transition flex items-center justify-center"
                                            >

    ...
    return (
        <>
            ...
            <div className="container mx-auto px-4 py-12 max-w-2xl">
                <div className="bg-admin-card rounded-3xl shadow-xl p-8 text-center">
                    ...
                    <p className="text-lg text-admin-muted mb-6">
                        Het admin panel is alleen toegankelijk voor commissieleden. Je bent momenteel geen lid van een commissie.
                    </p>

                    <div className="bg-admin-card-soft rounded-xl p-6 mb-8 text-left">
                        <h2 className="font-semibold text-admin mb-3 flex items-center gap-2">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link
                            href="/commissies"
                            className="inline-flex items-center justify-center gap-2 rounded-full bg-admin-card text-theme-purple dark:text-theme-purple-light border-2 border-theme-purple dark:border-theme-purple-light px-6 py-3 font-semibold hover:bg-admin-hover transition-all"
                        >
                            Bekijk Commissies
                        </Link>
                    </div>

        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div className="grid grid-cols-7 auto-rows-fr bg-gray-100 gap-px border-b border-gray-100">
              ...
              `}
                    ...
                    ${isDayToday ? 'bg-paars text-white' : 'text-gray-700'}
                  `}
                                >
                                    {format(day, 'd')}
                                </span>
                            ...
                            <div className="flex flex-col gap-1 mt-1 overflow-y-auto max-h-[100px] custom-scrollbar">
                                {dayEvents.map(event => (
                                    <button
                                        ...
                                        className="text-left text-xs p-1.5 rounded bg-roze/10 hover:bg-roze/20 border-l-2 border-roze text-paars font-medium truncate transition-all hover:scale-[1.02]"

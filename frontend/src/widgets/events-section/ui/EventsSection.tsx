            ...
            <div className="mx-auto max-w-app px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col gap-6 rounded-xl bg-gradient-theme px-6 sm:px-10 pt-8 sm:pt-10 md:pt-12 pb-8 sm:pb-10 md:pb-12 shadow-xl">
                    ...
                    {eventsLoading ? (
                        ...
                        <div className="w-full rounded-3xl bg-white/90 dark:bg-surface-dark/90 p-10 text-center flex items-center justify-center text-sm text-theme-purple dark:text-theme-white font-medium">

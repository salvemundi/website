            ...
            >
                ...
                {selectedLocation && (
                    <Marker latitude={selectedLocation.lat} longitude={selectedLocation.lng}>
                        <div className="samu-marker samu-marker--selected">≡ƒôì</div>
                    </Marker>
                )}
                        ...
                        <div className="map-popup">
                            ...
                            <div className="map-popup__head">
                                ...
                                <div>
                                    ...
                                    <div className="map-popup__meta">{popupInfo.city ? `≡ƒôì ${popupInfo.city}` : ''}{popupInfo.country ? ` ΓÇó ≡ƒîì ${popupInfo.country}` : ''}</div>
                                </div>
                            </div>

...
export const PUB_CRAWL_SIGNUP_FIELDS = [
    ...
    'name_initials', 'payment_status', 'pub_crawl_event_id', 'created_at', 'directus_relations', 'group_name'
] as const;
...
export const TRIP_FIELDS = [
    'id', 'name', 'description', 'image', 'start_date', 'end_date', 'registration_start_date', 'registration_open', 'max_participants', 'max_crew', 'base_price', 'crew_discount', 'deposit_amount', 'is_bus_trip', 'allow_final_payments', 'allow_deposit_payments'
] as const;
...
export const TRIP_SIGNUP_FIELDS = [
    ...
    'document_number', 'document_expiry_date', 'terms_accepted', 'directus_relations', 
    'allergies', 'special_notes', 'willing_to_drive', 'extra_luggage', 'access_token',

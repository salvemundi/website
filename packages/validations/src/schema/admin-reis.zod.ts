...
export const tripSchema = z.object({
    id: z.number().int(),
    name: z.string(),
    description: z.preprocess((v) => (v === null || v === undefined) ? v : (v === '' ? null : String(v)), z.string().nullable().optional()),
    image: z.preprocess((v) => (v === null || v === undefined) ? v : (v === '' ? null : String(v)), z.string().nullable().optional()),
    start_date: z.preprocess((v) => (v === null || v === undefined) ? v : (v === '' ? null : String(v)), z.string().nullable().optional()),
    end_date: z.preprocess((v) => (v === null || v === undefined) ? v : (v === '' ? null : String(v)), z.string().nullable().optional()),
    registration_start_date: z.preprocess((v) => (v === null || v === undefined) ? v : (v === '' ? null : String(v)), z.string().nullable().optional()),

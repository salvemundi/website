import { pgTable, unique, serial, varchar, index, foreignKey, check, integer, date, timestamp, uuid, text, json, boolean, doublePrecision, real, bigint, numeric, time, inet, jsonb, bigserial } from "drizzle-orm/pg-core"

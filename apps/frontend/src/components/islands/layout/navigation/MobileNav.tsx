...
export function MobileNav({ user, isAuthenticated, navItems, canAccessAdmin }: Omit<MobileNavProps, 'onLogout'>) {
    ...
    return (
        <>
            <button
                type="button"
                className="relative z-[210] inline-flex items-center justify-center rounded-full p-2 text-[var(--text-main)] shadow-sm transition-transform duration-200 hover:scale-110 active:scale-95 hover:bg-[var(--color-purple-100)] dark:hover:bg-white/10 lg:hidden"

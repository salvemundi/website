...
export default function VacancyCard({ vacancy }: VacancyCardProps) {
    ...
    return (
        <div
            ...
            className="group relative z-0 overflow-hidden w-full rounded-[1.75rem] bg-(--bg-card) dark:border dark:border-white/10 shadow-sm transition-all cursor-pointer hover:shadow-md hover:-translate-y-1 flex flex-col"
        >
            {vacancy.image && (
            ...
            <div className="p-5 flex flex-col gap-3 grow">
                ...
                <div className="text-(--text-muted) text-sm line-clamp-3 leading-relaxed wrap-break-word overflow-hidden">

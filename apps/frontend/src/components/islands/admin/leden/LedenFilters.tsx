        ...
        <div className="flex flex-col lg:flex-row gap-4 mb-8 items-stretch lg:items-center justify-between">
            ...
            <div className="flex p-1 bg-(--beheer-card-soft) rounded-(--beheer-radius) border border-(--beheer-border) shadow-sm w-full lg:w-auto self-stretch lg:self-auto">
                <button
                    ...
                    className={`tab-button flex-1 lg:flex-none px-6 py-2 rounded-[calc(var(--beheer-radius)-4px)] text-xs font-bold transition-all flex items-center justify-center gap-2 cursor-pointer ${activeTab === 'active'
                ...
                <button
                    ...
                    className={`tab-button flex-1 lg:flex-none px-6 py-2 rounded-[calc(var(--beheer-radius)-4px)] text-xs font-bold transition-all flex items-center justify-center gap-2 cursor-pointer ${activeTab === 'inactive'
                        ? 'bg-(--beheer-accent) text-white shadow-sm'
                        : 'text-(--beheer-text-muted) hover:text-(--beheer-text) hover:bg-white/30 dark:hover:bg-white/5'
                        }`}
                >
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center w-full lg:w-auto">
                ...
                {onExport && (
                    <button
                        onClick={onExport}
                        className="beheer-button flex items-center justify-center gap-2 px-5 py-2.5 bg-(--beheer-card-bg) border border-(--beheer-border) text-(--beheer-text) rounded-(--beheer-radius) text-xs font-semibold hover:border-(--beheer-accent)/50 hover:bg-(--beheer-card-soft) transition-all active:scale-95 shadow-sm disabled:opacity-50 cursor-pointer whitespace-nowrap"
                    >
                ...
                {onReminder && (
                    <button
                        ...
                        className="beheer-button flex items-center justify-center gap-2 px-5 py-2.5 bg-(--beheer-accent) text-white font-semibold text-xs rounded-(--beheer-radius) shadow-md hover:opacity-95 transition-all active:scale-95 disabled:opacity-50 cursor-pointer whitespace-nowrap"
                    >

...
} from '@/server/actions/admin/trip-mail.actions';
...
interface TripMailIslandProps {
    trips: Trip[];
    initialSignups: TripSignup[];
    initialSelectedTripId: number;
}

export default function TripMailIsland({ trips, initialSignups, initialSelectedTripId }: TripMailIslandProps) {

                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-8">
                                    <div>
                                        ...
                                        <textarea id="description" name="description" rows={8} autoComplete="off" suppressHydrationWarning className={`beheer-input ${formErrors.description ? 'border-red-500 ring-4 ring-red-500/10' : ''}`} placeholder="Wat gaan we doen?" />
                                    ...
                                    <div>
                                        ...
                                        <textarea id="description_logged_in" name="description_logged_in" rows={4} autoComplete="off" suppressHydrationWarning className="beheer-input" placeholder="Bijv. verzamelplek, wat mee te nemen..." />
                                    </div>
                                </div>
                        ...
                        <div className="p-8 space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                <div className="lg:col-span-2">
                                    ...
                                    <input type="date" id="event_date" name="event_date" autoComplete="off" suppressHydrationWarning className={`beheer-input ${formErrors.event_date ? 'border-red-500' : ''}`} />
                                ...
                                <div className="lg:col-span-2">
                                    ...
                                    <input type="time" id="event_time" name="event_time" autoComplete="off" suppressHydrationWarning className="beheer-input" />
                                </div>
                                <div className="lg:col-span-2">
                                    ...
                                    <input type="date" id="event_date_end" name="event_date_end" autoComplete="off" suppressHydrationWarning className="beheer-input" />
                                </div>
                                <div className="lg:col-span-2">
                                    ...
                                    <input type="time" id="event_time_end" name="event_time_end" autoComplete="off" suppressHydrationWarning className="beheer-input" />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="location" name="location" autoComplete="off" suppressHydrationWarning className="beheer-input" placeholder="Bijv. Fontys R10 of Eindhoven Centrum" />
                                </div>
                                <div>
                                    ...
                                    <input type="datetime-local" id="registration_deadline" name="registration_deadline" autoComplete="off" suppressHydrationWarning className="beheer-input" />
                                </div>
                            </div>
                            ...
                            <div className="pt-4 border-t border-[var(--beheer-border)]">
                                <div>
                                    ...
                                    <input type="text" id="custom_url" name="custom_url" autoComplete="off" suppressHydrationWarning className="beheer-input" placeholder="bijv. https://forms.gle/..." />
                                </div>
                            </div>
                        </div>
                    </div>

                    {/* Section 3: Registratie & Kosten + Status sidebar */}
                                ...
                                <div className="p-8 space-y-8">
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div>
                                            ...
                                            <input type="number" id="max_sign_ups" name="max_sign_ups" min="0" autoComplete="off" suppressHydrationWarning className="beheer-input" placeholder="Onbeperkt" />
                                        </div>
                                        <div>
                                            ...
                                            <input type="number" id="price_members" name="price_members" min="0" step="0.01" autoComplete="off" suppressHydrationWarning className="beheer-input" placeholder="0.00" />
                                        </div>
                                        <div>
                                            ...
                                            <input type="number" id="price_non_members" name="price_non_members" min="0" step="0.01" autoComplete="off" suppressHydrationWarning className="beheer-input" placeholder="0.00" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-[var(--beheer-border)] pt-8">
                                        <div>
                                            ...
                                            <select id="committee_id" name="committee_id" autoComplete="off" suppressHydrationWarning className="beheer-select">
                                        ...
                                        <div>
                                            ...
                                            <input type="email" id="contact" name="contact" autoComplete="off" suppressHydrationWarning className="beheer-input" placeholder="naam@salvemundi.nl" />
                                        </div>
                                    </div>
                                            ...
                                            <div className="flex-1">
                                                ...
                                                {status === 'scheduled' && (
                                                    <div className="mt-4 animate-in slide-in-from-top-2 duration-300">
                                                        <input type="datetime-local" name="publish_date" autoComplete="off" suppressHydrationWarning className="beheer-input bg-[var(--beheer-card-soft)]" />
                                                    </div>
                                                )}
                                            </div>
                                        </label>

...
} from '@/server/actions/admin/trip-core.actions';
...
interface TripSettingsIslandProps {
    initialTrips: Trip[];
    initialSettings: { show: boolean };
}

export default function TripSettingsIsland({ initialTrips, initialSettings }: TripSettingsIslandProps) {
    ...
    const handleToggleVisibility = () => {
        startTransition(async () => {
            try {
                ...
                safeConsoleError('[TripSettingsIsland.tsx][TripSettingsIsland] ', error);

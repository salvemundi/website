                                                                    ...
                                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                                                        ...
                                                                        <div className="flex flex-col gap-2 sm:col-span-2">
                                                                            ...
                                                                            <textarea
                                                                                ...
                                                                                className="bg-(--beheer-card-bg) border border-(--beheer-border) rounded-lg px-3 py-2 text-(--beheer-text) text-xs font-semibold focus:ring-2 focus:ring-(--beheer-accent) outline-none min-h-[100px] resize-none"
                                                                            />
                                                                        </div>
                                                                    </div>
                                                                </div>

                                    ...
                                    <Fragment key={p.id}>
                                        ...
                                        >
                                            <td className="px-8 py-5">
                                                <div className={`size-2.5 rounded-full shadow-[0_0_10px_rgba(0,0,0,0.1)] transition-all ${p.approved ? 'bg-emerald-500 shadow-emerald-500/40' : 'bg-(--beheer-border) opacity-30'}`} />
                                            </td>
                                            <td className="px-8 py-5">
                                                                ...
                                                                <div className="space-y-6">
                                                                    ...
                                                                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                                                        ...
                                                                        <div className="flex flex-col gap-2 sm:col-span-2">
                                                                            <span className="text-[9px] opacity-50">Motivatie</span>
                                                                            <textarea
                                                                ...
                                                                <div className="space-y-4">
                                                                    ...
                                                                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                                        <div className="flex flex-col gap-1">
                                                                            ...
                                                                            <span className="text-sm font-semibold text-(--beheer-text)">{p.created_at ? formatDate(p.created_at) : '-'}</span>
                                                                        </div>
                                                                        <div className="flex flex-col gap-1">
                                                                    ...
                                                                    {p.motivation && (
                                                                        <div className="mt-6 space-y-4">
                                                                            ...
                                                                            <div className="rounded-2xl border border-(--beheer-border)/20 bg-white/5 p-6">
                                                                                <p className="text-sm leading-relaxed font-medium text-(--beheer-text) italic">
                                                                                    &quot;{p.motivation}&quot;
                                                                                </p>
                                                                            </div>
                                                                        </div>

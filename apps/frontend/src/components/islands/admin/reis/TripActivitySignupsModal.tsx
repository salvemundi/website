...
export default function TripActivitySignupsModal({ activityName, options, signups, loading, onClose }: Props) {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-md">
            <div className="bg-[var(--beheer-card-bg)]/90 backdrop-blur-xl w-full max-w-4xl rounded-[2rem] shadow-[0_40px_100px_rgba(0,0,0,0.5)] overflow-hidden border border-[var(--beheer-border)]/50 flex flex-col max-h-[90vh]">
                <div className="p-8 border-b border-[var(--beheer-border)] flex items-center justify-between">
                    <div className="space-y-1">
                        ...
                        <p className="text-[10px] font-semibold text-[var(--beheer-text-muted)] opacity-60 ml-14">{activityName}</p>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto p-8">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-24">
                            ...
                            <p className="text-[10px] font-semibold text-[var(--beheer-text-muted)]">Data laden...</p>
                        </div>
                    ) : signups.length === 0 ? (
                        ...
                        <div className="border border-[var(--beheer-border)]/50 rounded-3xl overflow-hidden shadow-sm">
                            <table className="w-full text-left">
                                <thead className="bg-[var(--beheer-card-soft)]/50 border-b border-[var(--beheer-border)]">
                                    <tr className="text-[10px] font-semibold text-[var(--beheer-text-muted)]">
                                ...
                                <tfoot className="bg-[var(--beheer-card-soft)]/20 border-t border-[var(--beheer-border)]/50">
                                    <tr>
                                        <td colSpan={3} className="px-8 py-5 text-[10px] font-semibold text-[var(--beheer-text-muted)] opacity-60">
                ...
                <div className="p-8 border-t border-[var(--beheer-border)]/50 bg-[var(--beheer-card-soft)]/20 flex justify-end">
                    <button
                        onClick={onClose}
                        className="px-10 py-4 bg-[var(--beheer-accent)] text-white rounded-xl font-semibold text-[10px] shadow-xl transition-all hover:opacity-90 active:scale-95 border border-white/10"
                    >
                        Venster Sluiten
                    </button>
                </div>

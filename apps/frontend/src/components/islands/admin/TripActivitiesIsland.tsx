...
import { deleteTripActivity, createTripActivity, updateTripActivity } from '@/server/actions/admin/trip-activities.actions';
...
export default function TripActivitiesIsland({
    initialTrips = [],
    initialActivities = [],

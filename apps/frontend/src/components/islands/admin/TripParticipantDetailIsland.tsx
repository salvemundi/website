...
} from '@/server/actions/admin/trip-signups.actions';
...
interface TripParticipantDetailIslandProps {
...
export default function TripParticipantDetailIsland({
    initialSignup,
    trips,
    allActivities,
    initialSelectedActivities
}: TripParticipantDetailIslandProps) {
    ...
    const handleUpdateActivities = async () => {
        ...
        try {
            ...
            safeConsoleError('[TripParticipantDetailIsland.tsx][TripParticipantDetailIsland] ', error);

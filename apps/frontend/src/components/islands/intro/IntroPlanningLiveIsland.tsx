                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <a
                            ...
                            className="inline-flex items-center gap-2 squircle bg-purple-600 text-white px-4 py-2.5 text-sm font-semibold shadow-md hover:shadow-lg hover:scale-[1.02] transition-all"
                        >
                        ...
                        <button
                            ...
                            className="btn-subscribe inline-flex items-center gap-2 squircle bg-bg-main border border-border-color dark:border-white/10 text-text-main px-4 py-2.5 text-sm font-semibold shadow-sm hover:shadow-md transition-all"
                        >
                            {copied ? <Check className="h-4 w-4 text-emerald-500" /> : <Rss className="h-4 w-4" />}
                            {copied ? 'Link gekopieerd' : 'Abonneer op agenda'}
                        </button>
                    </div>
                </div>

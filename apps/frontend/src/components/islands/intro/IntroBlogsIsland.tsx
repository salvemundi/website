        ...
        <section className="mt-20 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                <div className="space-y-2">
                    ...
                    <h2 className="text-3xl lg:text-4xl font-black tracking-tight text-theme-purple">
                        Laatste nieuws
                    </h2>
                </div>
                <Link 
                    href="/intro/blogs" 
                    className="flex items-center gap-2 text-[11px] font-semibold text-text-muted hover:text-theme-purple transition-colors group"
                >

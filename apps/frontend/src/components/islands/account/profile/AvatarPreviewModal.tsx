...
export default function AvatarPreviewModal({ 
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-[var(--bg-card)] squircle-xl p-8 max-w-sm w-full shadow-2xl border border-white/10 flex flex-col items-center text-center animate-in zoom-in-95 duration-300">
                ...
                <div className="flex flex-col w-full gap-3">
                    <button
                        onClick={onConfirm}
                        disabled={isPending}
                        className="w-full py-4 squircle bg-[var(--color-purple-600)] text-white font-black text-lg shadow-xl shadow-purple-600/20 transition-all hover:scale-[1.02] hover:bg-[var(--color-purple-500)] active:scale-95 disabled:opacity-50"
                    >

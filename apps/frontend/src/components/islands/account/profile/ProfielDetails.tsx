...
export default function ProfielDetails({
    ...
    const logoutButton = (
        <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl text-base font-bold text-red-500 bg-red-500/5 hover:bg-red-500/10 border border-red-500/10 transition-all active:scale-95 group cursor-pointer"
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-4 rounded-2xl bg-slate-50 dark:bg-black/20 p-5 border border-slate-200 dark:border-white/10 shadow-sm">
                    ...
                    <div className="min-w-0 flex-1 overflow-hidden">
                        <p className="text-base text-[var(--color-purple-400)] font-bold mb-1">
                            E-mailadres
                        </p>
                        <p className="font-bold text-[var(--color-purple-700)] dark:text-white break-words text-base leading-tight">
                ...
                <div className="rounded-2xl bg-slate-50 dark:bg-black/20 p-5 border border-slate-200 dark:border-white/10 shadow-sm relative group">
                    ...
                    <div className="flex items-center gap-4 min-w-0">
                        ...
                        {isEditingPhoneNumber ? (
                            ...
                            <p className="font-bold text-[var(--color-purple-700)] dark:text-white text-base">

        ...
        >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                    <p className="text-[11px] text-licht-paars dark:text-geel font-black uppercase tracking-wider text-left pl-1">
                        E-mailadres
                    </p>
                    <div className="flex items-center gap-4 rounded-2xl bg-licht-paars/10 dark:bg-white/5 p-5 border border-licht-paars/20 dark:border-white/10 shadow-sm min-h-[68px]">
                ...
                <div className="flex flex-col gap-1.5">
                    <p className="text-[11px] font-black uppercase text-licht-paars dark:text-geel tracking-wider text-left pl-1">
                        Geboortedatum
                    </p>
                    <div className="flex items-center gap-4 rounded-2xl bg-licht-paars/10 dark:bg-white/5 p-5 border border-licht-paars/20 dark:border-white/10 shadow-sm min-h-[68px]">
                        <div className="shrink-0 flex items-center justify-center text-purple-600 dark:text-[var(--color-purple-300)]">

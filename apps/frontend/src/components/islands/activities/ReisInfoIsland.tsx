...
export function ReisInfoIsland({ nextTrip, isLoading = false }: ReisInfoIslandProps) {
    ...
    if (isLoading) {
        return (
            <div className="w-full lg:w-1/2 flex flex-col gap-8 animate-pulse" aria-busy="true">
                ...
                <div className="bg-[var(--bg-card)] dark:border dark:border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-lg">
                    <Skeleton className="w-full h-48 sm:h-64 md:h-80 bg-[var(--text-muted)]/5" rounded="2xl" />
                    <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-slate-100 dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/30">
                        <div className="flex items-center gap-3 sm:gap-4 w-full">
                            ...
                            <div className="space-y-2 flex-1">
                                <Skeleton className="h-3 w-24 bg-[var(--text-muted)]/10" rounded="full" />

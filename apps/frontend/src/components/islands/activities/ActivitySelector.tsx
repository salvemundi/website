    ...
    return (
        <div className="space-y-6">
            <h3 className="text-xl font-bold text-white flex items-center gap-2">
                <Plus className="w-5 h-5 text-[var(--sm-orange)]" />
                    ...
                    return (
                        ...
                        >
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        {Number(activity.price) > 0 && (
                                            <span className="px-2 py-0.5 rounded-full bg-orange-500/20 text-[var(--sm-orange)] text-xs font-bold">
                            ...
                            {isSelected && hasOptions && (
                                <div className="px-5 pb-5 pt-0 border-t border-orange-500/10 mt-2">
                                    <p className="text-xs font-black uppercase tracking-widest text-[var(--sm-orange)] mb-3 mt-4">

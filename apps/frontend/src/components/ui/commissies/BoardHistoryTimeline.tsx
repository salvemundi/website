...
export default function BoardHistoryTimeline({ boards }: BoardHistoryTimelineProps) {
    ...
    return (
        <div className="relative">
            <div className="absolute left-1/2 top-0 bottom-0 w-px bg-linear-to-b from-purple-500/0 via-purple-500/20 to-purple-500/0 hidden lg:block -translate-x-1/2" />

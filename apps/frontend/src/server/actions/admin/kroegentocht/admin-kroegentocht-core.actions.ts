...
import * as events from './admin-kroegentocht-event.actions';
import * as signups from './admin-kroegentocht-signup.actions';
import * as settings from './admin-kroegentocht-settings.actions';

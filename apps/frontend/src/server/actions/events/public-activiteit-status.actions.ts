...
import { fetchEventSignupByIdDb, fetchUserEventSignupsDb } from '@/server/internal/event-db.utils';
import { fetchPubCrawlSignupByIdDb, fetchUserPubCrawlSignupsDb } from '@/server/internal/kroegentocht-db.utils';
    ...
    try {
        ...
        if (financeId) {
            ...
            try {
                ...
                console.error('[SignupStatus] Finance service live check failed:', error);
            }

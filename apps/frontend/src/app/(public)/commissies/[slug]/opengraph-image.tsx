                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', maxWidth: '70%' }}>
                            <p style={{ fontSize: 22, fontWeight: 700, color: '#5A3761', textTransform: 'uppercase', letterSpacing: 4, marginBottom: 12 }}>
                                COMMISSIE
                            </p>
                        ...
                        <div style={{
                            ...
                            marginTop: 20,
                             ...
                             <div style={{
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5A3761" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 8 }}><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /></svg>
                                <span style={{ fontSize: 24, fontWeight: 800, color: '#5A3761' }}>Actieve Leden</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ position: 'absolute', top: 30, left: 30, display: 'flex', alignItems: 'center', gap: 8 }}>
                        <div style={{ width: 32, height: 32, backgroundColor: '#5A3761', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>

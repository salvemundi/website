    ...
    return (
        <PublicPageShell title="Betaling Status" hideHeader={true}>
            <div className="container mx-auto px-4 py-32 max-w-2xl min-h-[80vh] flex items-center justify-center">
                {isPaid ? (
                    <div className="flex flex-col items-center justify-center text-center p-12 bg-bg-card border border-border-color rounded-3xl backdrop-blur-xl shadow-2xl">

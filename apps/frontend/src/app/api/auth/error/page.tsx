...
export default function Page() {
    return (
        <div className="flex min-h-[80vh] flex-col items-center justify-center p-6 text-center">
            <div 
                className="max-w-md w-full p-10 rounded-2xl shadow-xl border border-(--border-color) transition-all"
                style={{ backgroundColor: 'var(--bg-card)', color: 'var(--text-main)' }}
            >
                <div className="mb-6 flex justify-center">
                    <div className="p-3 rounded-full" style={{ backgroundColor: 'rgba(varpurple-500-rgb, 0.1)' }}>

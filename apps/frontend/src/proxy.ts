...
export const config = {
    matcher: ['/((?!_next/static|_next/image|fonts|map|img|favicon.ico|robots.txt|.well-known|sw.js|manifest.json|manifest.webmanifest|workbox-|logo.png|icons/|api/assets|api/auth).*)']
};

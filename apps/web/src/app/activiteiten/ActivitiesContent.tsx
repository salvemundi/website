...
import { getEventsAction } from "@/shared/api/event-actions";
import { addMonths, subMonths } from 'date-fns';
import FlipClock from "@/shared/ui/FlipClock";
import { ActivityCardSkeleton } from '@/shared/ui/skeletons';
import { Event } from "@/shared/model/types/directus";


export default function ActivitiesContent({ initialEvents }: { initialEvents: Event[] }) {
    const router = useRouter();
    const searchParams = useSearchParams();
    const { data: events = initialEvents, isLoading, error } = useQuery({
        queryKey: ['events'],

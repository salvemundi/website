...
export default function CommitteesContent({ initialCommittees }: { initialCommittees: Committee[] }) {
    const { data: committeesData = initialCommittees, isLoading, error } = useSalvemundiCommitteesWithMembers({
        ...
        <>
            <div className="relative z-10">
                ...
                <main className="mx-auto max-w-app px-4 py-12 sm:px-6 lg:px-8">
                    {isLoading && !committeesData.length ? (
